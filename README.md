...
We have made several changes to the AdvReverb algorithm implementation to improve its effectiveness and stealthiness. The improved code is called 'ImprovedRIR.py'. Those changes are summarized below:
